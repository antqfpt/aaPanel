#! /bin/bash
# By Aaron
# https://github.com/antqfpt/aaPanel
...
wget -O "/root/aapanel-install.sh" "https://raw.githubusercontent.com/antqfpt/aapanel/main/script/install_6.0_en.sh"
...
# 安装bt面板
function bt-install(){  
wget -O "/root/bt-install.sh" "https://raw.githubusercontent.com/antqfpt/aapanel/main/script/install_6.0.sh"
...
wget -O "/root/LinuxPanel_EN-6.8.23.zip" "https://github.com/antqfpt/aaPanel/releases/download/v1.0/LinuxPanel_EN-6.8.23.zip"
red "Download complete, downgrading."
unzip LinuxPanel_EN-6.8.23.zip
cd /root/panel
wget -O "/root/panel/downgrade.sh" "https://raw.githubusercontent.com/antqfpt/aapanel/main/script/downgrade.sh" 
...
wget -O "/root/LinuxPanel-7.7.0.zip" "https://github.com/antqfpt/aaPanel/releases/download/v1.0/LinuxPanel-7.7.0.zip"
...
wget https://raw.githubusercontent.com/antqfpt/aaPanel/main/resource/repair.json
chattr +i /www/server/panel/data/repair.json
...
wget -O /root/chinese.zip https://github.com/antqfpt/aaPanel/releases/download/v1.0/aapanel_chinese-6.8.21.zip
...
function start_menu(){
    ...
    purple " https://github.com/antqfpt/aaPanel"
    yellow " ————————————————————————————————————————————————"
